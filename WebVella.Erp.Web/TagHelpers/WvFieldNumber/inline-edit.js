...
function NumberInlineEditGenerateSelectors(fieldId, fieldName, entityName, recordId, config) {
...
function NumberInlineEditPreEnableCallback(fieldId, fieldName, entityName, recordId, config) {
...
function NumberInlineEditPreDisableCallback(fieldId, fieldName, entityName, recordId, config) {
	var selectors = NumberInlineEditGenerateSelectors(fieldId, fieldName, entityName, recordId, config);
...
function NumberInlineEditInit(fieldId, fieldName, entityName, recordId, config) {
	...
	$(selectors.viewWrapper + " .action.btn").on("click", function (event) {
		...
		NumberInlineEditPreEnableCallback(fieldId, fieldName, entityName, recordId, config);
	});
	...
	$(selectors.editWrapper + " .save").on("click", function (event) {
		...
		$.ajax({
			...
			success: function (response) {
				if (response.success) {
					NumberInlineEditInitSuccessCallback(response, fieldId, fieldName, entityName, recordId, config);
				}
				else {
...
function NumberInlineEditInitSuccessCallback(response, fieldId, fieldName, entityName, recordId, config) {
	var selectors = NumberInlineEditGenerateSelectors(fieldId, fieldName, entityName, recordId, config);
