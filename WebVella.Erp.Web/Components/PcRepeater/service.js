...
(function(window, $) {
	...
	//		if (event && event.payload && event.payload.component_name === "WebVella.Erp.Web.Components.PcRecordList"){
	...
	//		if (event && event.payload && event.payload.component_name === "WebVella.Erp.Web.Components.PcRecordList"){
	//			console.log("WebVella.Erp.Web.Components.PcRecordList Options unloaded");
	//		}
	//	});
	//});
