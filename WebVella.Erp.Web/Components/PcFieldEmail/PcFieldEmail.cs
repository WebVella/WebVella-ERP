	...
	public class PcFieldEmail : PcFieldBase
	{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var instanceOptions = PcFieldEmailOptions.CopyFromBaseOptions(baseOptions);
				if (context.Options != null)
				{
					instanceOptions = JsonConvert.DeserializeObject<PcFieldEmailOptions>(context.Options.ToString());
