	...
	public class PcFieldImage : PcFieldBase
	{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var instanceOptions = PcFieldImageOptions.CopyFromBaseOptions(baseOptions);
				if (context.Options != null)
				{
					instanceOptions = JsonConvert.DeserializeObject<PcFieldImageOptions>(context.Options.ToString());
					...
					//		if (entityField != null && entityField is ImageField)
					//		{
					//			var castedEntityField = ((ImageField)entityField);
