	...
	public class PcFieldCurrency : PcFieldBase
	{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var instanceOptions = PcFieldCurrencyOptions.CopyFromBaseOptions(baseOptions);
				if (context.Options != null)
				{
					instanceOptions = JsonConvert.DeserializeObject<PcFieldCurrencyOptions>(context.Options.ToString());
					...
					if (instanceOptions.TryConnectToEntity)
					{
						...
						if (entity != null && entity is Entity)
						{
							...
							if (entityField != null && entityField is CurrencyField)
							{
								...
								instanceOptions.CurrencyCode = castedEntityField.Currency.Code;
