import { h } from '../wv-feed-list.core.js';
...
class WvPost {
    ...
    render() {
        ...
        let userName = "system";
        let hrTime = hooks(scope.record["created_on"]).fromNow();
        let timeString = hooks(scope.record["created_on"]).format('YYYY MM DD HH:mm');
...
export { WvPost as WvFeed, WvPostList as WvFeedList };
