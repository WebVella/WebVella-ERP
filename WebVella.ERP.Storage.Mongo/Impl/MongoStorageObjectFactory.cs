...
namespace WebVella.ERP.Storage.Mongo
{
	public class MongoStorageObjectFactory : IStorageObjectFactory
	{
		...
		public IStorageRecordListViewItem CreateEmptyRecordListViewItemObject()
		{
			return new MongoRecordListViewItem();
		}

		public IStorageRecordListRelationViewItem CreateEmptyRecordListRelationViewItemObject()
		{
			return new MongoRecordListRelationViewItem();
		}

		public IStorageRecordListListItem CreateEmptyRecordListListItemObject()
		{
			return new MongoRecordListListItem();
		}

		public IStorageRecordListRelationListItem CreateEmptyRecordListRelationListItemObject()
		{
			return new MongoRecordListRelationListItem();
		}
		...
		public IStorageRecordViewSidebarItemBase CreateEmptyRecordViewSidebarItemBaseObject()
		{
			return new MongoRecordViewSidebarListItem();
		}

		public IStorageRecordViewSidebarListItem CreateEmptyRecordViewSidebarListItemObject()
		{
			return new MongoRecordViewSidebarListItem();
		}

		public IStorageRecordViewSidebarViewItem CreateEmptyRecordViewSidebarViewItemObject()
		{
			return new MongoRecordViewSidebarViewItem();
		}

		public IStorageRecordViewSidebarRelationListItem CreateEmptyRecordViewSidebarRelationListItemObject()
		{
			return new MongoRecordViewSidebarRelationListItem();
		}

		public IStorageRecordViewSidebarRelationViewItem CreateEmptyRecordViewSidebarRelationViewItemObject()
		{
			return new MongoRecordViewSidebarRelationViewItem();
		}
		...
		public IStorageRecordViewRelationViewItem CreateEmptyRecordViewRelationViewItemObject()
		{
			return new MongoRecordViewRelationViewItem();
		}

		public IStorageRecordViewRelationListItem CreateEmptyRecordViewRelationListItemObject()
		{
			return new MongoRecordViewRelationListItem();
		}
		...
		public IStorageRecordTree CreateEmptyRecordTreeObject()
		{
