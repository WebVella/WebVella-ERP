...
namespace WebVella.Erp.Plugins.Next.Controllers
{
	[Authorize]
	public class NextController : Controller
	{
		...
		public NextController(IErpService erpService)
		{
		...
		#region << Components >>
		[Route("api/v3.0/p/next/pc-post-list/create")]
		[HttpPost]
		...
		[Route("api/v3.0/p/next/pc-post-list/delete")]
		[HttpPost]
		...
		[Route("api/v3.0/p/next/pc-timelog-list/create")]
		[HttpPost]
		...
		[Route("api/v3.0/p/next/pc-timelog-list/delete")]
		[HttpPost]
		...
		[Route("api/v3.0/p/next/timelog/start")]
		[HttpPost]
		...
		[Route("api/v3.0/p/next/timelog/stop")]
		[HttpPost]
