...
(function (window, $) {
	...
	//	});
		...
		document.addEventListener("WvPbManager_Node_Moved", function (event) {
			if (event && event.payload && event.payload.component_name === "WebVella.Erp.Plugins.Next.Components.PcProjectDashboardOverview") {
				console.log("WebVella.Erp.Plugins.Next.Components.PcProjectDashboardOverview Moved");
			}
		});
	});
