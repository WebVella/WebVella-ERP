...
(function (window, $) {
	...
	//		if (event && event.payload && event.payload.component_name === "WebVella.Erp.Web.Components.PcPostList"){
	...
	//	if (event && event.payload && event.payload.component_name === "WebVella.Erp.Plugins.Next.Components.PcPostList") {
	//		console.log("WebVella.Erp.Plugins.Next.Components.PcPostList Moved");
	//	}
	//});
	});
