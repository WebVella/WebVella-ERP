...
var translationsEN = {
	...
	CYAN: 'Cyan',
	CURRENCY: 'Currency',
	CURRENT_NEXT_TRIGGER_DATE: 'Current Next trigger date',
	...
	DATA_LINK_QUERY_MODAL_URL_QUERY_NAME_DESCRIPTION:'The list controller will check the query parameters for keys that match the set string in the "options" attribute. If no match is found, it will use the default value. More than one rule can match the same query parameter key. <strong>The query parameter value should be encoded - "field_name" or "$relation_name.field_name".</strong> The same value needs to be converted without an error to the data format of the selected rule field. If an error occurs the default value will be returned instead.',
	...
	QUERY_RULE_FIELD_NAME_DESCRIPTION:'field_name or $realation_name.field_name',
	...
	SCHEDULE_PLAN_NAME:'Schedule plan name',
	SCHEDULE_PLAN_LAST_TRIGGER:'Last trigger',
	SCHEDULE_PLAN_NEXT_TRIGGER:'Next trigger',
	SCHEDULE_PLAN_UPDATE:'Update plan schedule',
	SCHEDULE_PLAN_DAYS:'Schedule days',
	MONDAY:'Monday',
	TUESDAY:'Tuesday',
	WEDNESDAY:'Wednesday',
	THURSDAY:'Thursday',
	...
	SATURDAY:'Saturday',
	SUNDAY:'Sunday',
	CURRENT_SCHEDULE_PLANS:'Current Schedule plans',
	SORT:'Sort',
	...
	START_TIMESPAN:'Start timespan hour',
	END_TIMESPAN:'End timespan hour',
	TIMESPAN:'Day hours',
	TARGET: 'Target',
	TEAL: 'Teal',
	TEMPLATE: 'Template',
